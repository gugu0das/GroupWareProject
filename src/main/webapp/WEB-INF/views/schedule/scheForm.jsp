    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper"> 
            ...
            <div class="row">
					...
					<div class="panel panel-default">
	                    <div class="panel-body">
	                    	...
	                    	<div class="row form-group">
	                            ...
	                            <div class="col-lg-8">
	                            	<label style="margin-right: 5px"><input type="radio" <c:if test='${scheInfo.ssisopen=="Y"}'>checked</c:if> 
	                            		 id="ssisopen" name="ssisopen" value="Y"> 공개</label>
	                            	<label style="margin-right: 5px"><input type="radio" <c:if test='${scheInfo.ssisopen=="N"}'>checked</c:if> 
		        ...
		        <button class="btn btn-outline btn-primary" onclick="fn_formSubmit()"></button>
		        <c:if test='${scheInfo.id!=null}'>
	            	<button class="btn btn-outline btn-primary" onclick="fn_delete()" ></button>
	            </c:if>
            </div>
            <!-- /.row -->
        </div> 
