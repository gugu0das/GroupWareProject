                            ...
                            <div class="col-lg-8 col-xl-6">
                            	...
                            	<form:form id="contactForm" modelAttribute="noticeVO" action="./add" method="post" data-sb-form-api-token="API_TOKEN" enctype="multipart/form-data">
	                                    ...
	                                    <div class="form-floating mb-3" id="fileList">
	                               			...
	                               			<div class="mb-3">
	                                    	<label for="files" class="form-label fw">첨부파일 추가</label>
	                                    ...
	                                    <!-- content input-->
	                                    <div class="form-floating mb-3">
	                                    	<label for="contents fw"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-4 -4 24 24" x="28" y="34"><g fill="none" fill-rule="evenodd" transform="translate(-4 -4)"><path d="M0 0h24v24H0z"/><rect width="15" height="15" x="4.5" y="4.5" fill="#FFF" stroke="#D3D3D3" rx="7.5"/><path fill="#D3D3D3" d="M8 11.5h8v1H8z"/></g></svg>내용</label>
