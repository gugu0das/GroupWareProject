									...
									<form:form modelAttribute="memberVO" method="post"
										...
										<div class="row gx-3 mb-3">
											...
											<div class="col-md-3">
												...
												<form:input path="name" cssClass="form-control change" id="name" readonly="true"/>
										...
										<div class="mb-3">
											...
											<form:input path="email" cssClass="form-control change" id="email" readonly="true"/>
										...
										<div class="row gx-3 mb-3">
											...
											<div class="col-md-4">
												...
												<form:input path="phone" cssClass="form-control change" id="phone" readonly="true"/>
											...
											<div class="col-md-4">
												<label for="birthDate">생일</label> <input
													...
													value="${memberVO.birthDate}" type="date" id="birthDate" readonly="true"/>

											</div>
											<div class="col-md-4">
												<label for="hireDate">입사일</label> <input
													class="form-control" name="hireDate"
													value="${memberVO.hireDate}" type="date" id="hireDate" style="border:none;" readonly="true" />
										...
										<div class="row gx-3 mb-3 ">
											...
											<div class="col-md-5">
												...
												<form:input path="jobVO.name" cssClass="form-control"  cssStyle="border:none;" readonly="true"
													id="jobVO.name" />
