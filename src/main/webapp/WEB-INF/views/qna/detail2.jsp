                    ...
                    <div class="row gx-5">
                        <div class="col-lg-3">
                            <div class="d-flex align-items-center mt-lg-5 mb-4">
                                ...
                                <div class="ms-3">
                                    <div class="fw-bold">${qnaCommentVO.writer}</div>
                                    <div class="text-muted">대댓글 달려면 여기로 오세요</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            ...
                            <article>
                                ...
                                <header class="mb-4">
                                    <!-- Post title-->
                                    <%-- <h1 class="fw-bolder mb-1">${qnaCommentVO.title}</h1> --%>
                                    <!-- Post meta content-->
                                    <div class="text-muted fst-italic mb-2">${qnaCommentVO.regDate}</div>
                                    <!-- Post categories-->
                             ...
                             <a href="./reply?id=${qnaCommentVO.id}" class="btn btn-danger">답글</a>
                            	<%-- </c:if> --%>
                            ...
                            <div class="mb-5">
                                  ...
                                  <div class="mb-3">
                                    <button type="button" class="btn btn-primary" id="replyAdd" data-qna-qnaId="${qnaCommentVO.id}">댓글등록</button>
                                  </div>
                            </div>
                            
                            
                            <a class="btn btn-primary" href="./delete?id=${qnaCommentVO.id}">글 삭제</a>
